   ...
   playerInfo.reset()
    ...
    if (playerInfo > 0) {
        ...
        if (playerInfo.health> 0 && i < enemyInfo.length - 1){
            // ask if player wants to use the store before the next rounds
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attact, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice."
    );
